...
| # | Name | Required | Type | Default | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | `type`  | ❌ | String | `'normal'` | The layer type. `'normal'` \| `'effect'` \| `'alpha'` |
| 2 | `style`  | ❌ | String | *`null`* | The second parameter, when the type is defined `'effect'` |
...
| `'alpha'` | The **blend style** is equivalent to globalCompositeOperation 'destination-in' to the following drawn layer. |
