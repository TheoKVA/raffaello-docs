...
| `'alpha'` | The **blend style** is equivalent to globalCompositeOperation 'alpha-in' to the following drawn layer. |
| **String** | Any knowned [globalCompositeOperation properties](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/globalCompositeOperation). E.g. `'multiply'`, `'screen'`, etc. |
